...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_binop','calculadora.py',32),
  ('expression -> expression MINUS term','expression',3,'p_expression_binop','calculadora.py',33),
  ('expression -> term','expression',1,'p_expression_term','calculadora.py',37),
  ('term -> term TIMES factor','term',3,'p_term_binop','calculadora.py',41),
  ('term -> term DIVIDE factor','term',3,'p_term_binop','calculadora.py',42),
  ('term -> factor','term',1,'p_term_factor','calculadora.py',46),
  ('factor -> NUMBER','factor',1,'p_factor_num','calculadora.py',50),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','calculadora.py',54),
]
